...
static const struct tegra_emc_table olympus_emc_tables_hynix_300Mhz[] = {
    {
//                  0x20,   /* Rev 2.0 */
...
struct tegra_emc_chip olympus_emc_chips[] = {
	...
	},
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = olympus_emc_tables_hynix_300Mhz,
		.table_size = ARRAY_SIZE(olympus_emc_tables_hynix_300Mhz)
	},
};
